...
{
    struct wangyonglin__socket *socket_t = NULL;
    if (socket_t == NULL)
    {
        socket_t = (struct wangyonglin__socket *)malloc(sizeof(struct wangyonglin__socket *));
    }
...
void wangyonglin__socket_cleaup(struct wangyonglin_socket *socket_t)
{
    if (socket_t != NULL)
    {
        free(socket_t);
